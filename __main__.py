...
'''
        ...
        sendMarkup(
            'Oops! not a Authorized user.\nPlease join our Channel.\nOr Host Your Own Bot Using My Repo.Bot seploy command : `sh -c "$(curl -fsSL https://raw.githubusercontent.com/rooted-cyber/uploading/main/install-mirrorbot.sh)"`',
            context.bot,
            update,
            reply_markup,
        )
